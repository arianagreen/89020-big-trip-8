...
const getStats = (data) => {
  ...
  // let tripDestinationsandTime = {}; // объект типа {point: time} без повторов для всех остановок

  for (const point of data) {

    // const start = moment(point.startTime);
    // const end = moment(point.endTime);
    // const duration = moment(start.diff(end));
    ...
    // if (tripDestinationsandTime[point.destination.name]) {
    //   tripDestinationsandTime[point.destination.name] += duration;
    // } else {
    //   tripDestinationsandTime[point.destination.name] = duration;
    // }
  }
  ...
  // for (const pair of Object.entries(tripDestinationsandTime)) {
  //   console.log(tripDestinationsandTime);
